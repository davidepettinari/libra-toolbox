...
def build_vault_model(settings=openmc.Settings(), tallies=openmc.Tallies(),
    ...
    def translate_surface(surface, dx, dy, dz):
    ...
    # 24
    Surface_24 = openmc.model.RectangularParallelepiped(1023.62-1104.9, 2247.9-1104.9, 0.0-99.38, 749.62-99.38, 0.0, 424.18)
    ...
    Surface_94 = openmc.model.RectangularParallelepiped(0.0-1104.9, 2247.9-1104.9, 0.0-99.38, 1998.37-99.38, -81.28, 0.0)
    ...
    Surface_13 = openmc.model.RectangularParallelepiped(1105.41-1104.9, 1166.3700000000001-1104.9, 368.0-99.38, 611.84-99.38, 0.0, 223.52)
    ...
    Surface_17 = openmc.model.RectangularParallelepiped(1066.8-1104.9, 1104.8999999999999-1104.9, 565.78-99.38, 598.8-99.38, 10.16, 213.35999999999999)
    ...
    Surface_18 = openmc.model.RectangularParallelepiped(1066.8-1104.9, 1104.8999999999999-1104.9, 380.71-99.38, 413.72999999999996-99.38, 10.16, 213.35999999999999)
    ...
    Surface_10 = openmc.model.RectangularParallelepiped(1741.65-1104.9, 1808.49-1104.9, 512.12-99.38, 637.85-99.38, 10.16, 152.4)
    ...
    Surface_9 = openmc.model.RectangularParallelepiped(1935.48-1104.9, 1983.74-1104.9, 512.12-99.38, 637.85-99.38, 10.16, 135.89000000000001)
    ...
    #
    # 11
    Surface_11 = openmc.model.RightCircularCylinder((1858.01-1104.9, 637.86-99.38, 111.76), 111.76, 15.24, axis='y')

    #
    # 2
    Surface_22 = openmc.model.RectangularParallelepiped(1699.2-1104.9, 2119.2-1104.9, 637.85-99.38, 668.33-99.38, 10.16, 363.22)
    ...
    #
    # 36
    Surface_36 = openmc.model.RectangularParallelepiped(1104.9-1104.9, 2254.9-1104.9, 0.0-99.38, 99.38-99.38, 0.0, 363.22)
    ...
    #
    # 16
    Surface_16 = openmc.model.RectangularParallelepiped(2050.0-1104.9, 2200.0-1104.9, 99.38-99.38, 668.34-99.38, 0.0, 363.22)
    ...
    #
    # 38
    Surface_38 = openmc.model.RectangularParallelepiped(1000.0-1104.9, 1150.0-1104.9, 380.71-99.38, 598.8-99.38, 10.16, 213.35999999999999)

    #
    # 39
    Surface_39 = openmc.model.RectangularParallelepiped(1023.62-1104.9, 1104.9-1104.9, 0.0-99.38, 749.62-99.38, 0.0, 363.22)
    ...
    #
    # 37
    Surface_37 = openmc.model.RectangularParallelepiped(1023.62-1104.9, 2253.62-1104.9, 0.0-99.38, 749.62-99.38, 363.22, 424.18)
    ...
    #
    # 12
    Surface_12 = openmc.model.RectangularParallelepiped(1169.67-1104.9, 2169.67-1104.9, 99.38-99.38, 668.34-99.38, 0.0, 10.16)

    # The bottom Vault floor in Room III 
    Vault_floor_reg = -Surface_12 & -Surface_48  

    # 23
    Surface_23 = openmc.model.RectangularParallelepiped(1104.9-1104.9, 2254.9-1104.9, 668.34-99.38, 749.62-99.38, 0.0, 363.22)

    #
    # The cyclotron beamline cutout in the north Vault shield wall
    Surface_102 = openmc.model.RightCircularCylinder((1422.0-1104.9, 668.34-99.38, 50.0), 81.28, 5.0, axis='y')
    ...
    #
    # 82
    Surface_82 = openmc.model.RectangularParallelepiped(1135.9-1104.9, 1147.3300000000002-1104.9, 138.75-99.38, 628.97-99.38, 276.86, 279.40000000000003)

    #
    # 83
    Surface_83 = openmc.model.RectangularParallelepiped(1135.9-1104.9, 1147.3300000000002-1104.9, 138.75-99.38, 628.97-99.38, 297.18, 299.72)

    #
    # 84
    Surface_84 = openmc.model.RectangularParallelepiped(1140.35-1104.9, 1142.8899999999999-1104.9, 138.75-99.38, 628.97-99.38, 276.86, 299.72)
    ...
    Surface_28 = openmc.model.RightCircularCylinder((1858.01-1104.9, 597.22-99.38, 99.7), 75.0, 20.95, axis='z')

    # 
    # Outer surface defining the bottom DANTE selection magnet
    Surface_30 = openmc.model.RightCircularCylinder((1858.01-1104.9, 597.22-99.38, 99.7), 8.0, 32.0, axis='z')
    ...
    Surface_35 = openmc.model.RightCircularCylinder((1858.01-1104.9, 597.22-99.38, 115.83), 8.0, 32.0, axis='z')
    ...
    Surface_21 = openmc.model.RectangularParallelepiped(1825.87-1104.9, 1890.1399999999999-1104.9, 571.9-99.38, 621.9-99.38, 99.7, 123.83)

    #
    # Surface definition of square box that contains DANTE selection magnets
    Surface_27 = openmc.model.RectangularParallelepiped(1816.1-1104.9, 1899.9199999999998-1104.9, 576.9-99.38, 617.54-99.38, 89.54, 133.99)

    #
    # Selection magnet SE support leg
    Surface_29 = openmc.model.RectangularParallelepiped(1892.3-1104.9, 1899.9199999999998-1104.9, 576.9-99.38, 584.52-99.38, 10.16, 88.89999999999999)

    #
    # Selection magnet NE support leg
    Surface_31 = openmc.model.RectangularParallelepiped(1892.3-1104.9, 1899.9199999999998-1104.9, 609.92-99.38, 617.54-99.38, 10.16, 88.89999999999999)

    #
    # Selection magnet SW support leg
    Surface_33 = openmc.model.RectangularParallelepiped(1816.1-1104.9, 1823.7199999999998-1104.9, 576.9-99.38, 584.52-99.38, 10.16, 88.89999999999999)

    #
    # Thin selection magnet table top plate
    Surface_34 = openmc.model.RectangularParallelepiped(1816.1-1104.9, 1899.9199999999998-1104.9, 576.9-99.38, 617.54-99.38, 88.9, 89.54)
    ...
    Region_1000 = -Surface_95 & ~Vault_door_reg & ~Vault_door_shield_n_pillar_reg & ~Vault_door_shield_s_pillar_reg & ~DANTE_vault_w_shield_reg & ~DANTE_vault_e_shield_reg & ~Vault_north_wall_ext_reg & ~Region_21 & ~South_vault_wall_reg & ~East_vault_wall_reg & ~West_vault_wall_reg & ~Vault_ceiling_reg & ~Vault_floor_reg & ~North_vault_wall_reg & ~I_beam_reg & ~DANTE_vault_bot_magnet_reg & ~DANTE_vault_top_magnet_reg & ~DANTE_vault_mag_stand_reg & ~Region_28
